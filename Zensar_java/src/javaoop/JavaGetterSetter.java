...
/*
 * Setter Method : start with 'set' followed by variable name,this method take argument and assign it to the member.
 * Getter Method : start with 'get'  followed by variable name,this method return value .
 */
