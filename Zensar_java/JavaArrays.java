...
//1		
		...
		System.out.println("Element at index number 0 to 9= "+arrayVar); // way 3 (here we print the object memory location, since array is an object)
...
//3
				...
				System.out.println("Element at index number 6 = "+arrayVar2[6]);
